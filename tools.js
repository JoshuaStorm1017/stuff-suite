...
const TOOLS = [
  ...
  { name: "ReelStuff", tag: "Free Loom alternative", pitch: "Screen + webcam-bubble recording with a private local library, trim editor and GIF export.", strike: "5-min cap, 25 videos", after: "no caps, 100% local", chips: ["Browser", "Vanilla JS"], repo: "https://github.com/JoshuaStorm1017/reelstuff", accent: "#ff9d66", status: "live" },
];
